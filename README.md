...
| 스타일수·SKU·기획량 | **MDP 파일**(`data/26FW_MDP.xlsb`, MDP 시트: 메인품번 AB · 시즌 E · 구분 F · 아이템코드 H · 컬러명 AM · 컬러별수량 AN) 기준. SKU = 컬러 행 수, 기획량 = 컬러별수량 합. MDP 가 갱신되면 NAS 의 새 파일을 `data/26FW_MDP.xlsb` 로 복사한다 |
